...
def convert_roberta_checkpoint_to_pytorch(roberta_checkpoint_path, pytorch_dump_folder_path, classification_head):
    ...
    for i in range(config.num_hidden_layers):
        ...
        self_attn.query.weight.data = roberta_layer.self_attn.q_proj.weight.data
        self_attn.query.bias.data = roberta_layer.self_attn.q_proj.bias.data
        self_attn.key.weight.data = roberta_layer.self_attn.k_proj.weight.data
        self_attn.key.bias.data = roberta_layer.self_attn.k_proj.bias.data
        self_attn.value.weight.data = roberta_layer.self_attn.v_proj.weight.data
        self_attn.value.bias.data = roberta_layer.self_attn.v_proj.bias.data
